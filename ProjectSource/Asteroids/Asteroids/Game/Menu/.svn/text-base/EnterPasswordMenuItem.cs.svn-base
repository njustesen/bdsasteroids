...
namespace Asteroids {
    ...
    /// <summary>
    /// The menu item used for entering a password to create a new user.
    /// </summary>
    class EnterPasswordMenuItem : Selectable {
        ...
        List<Keys> validChars = new List<Keys>() {
            ...
            Keys.Z, Keys.W, Keys.D0, Keys.D1, Keys.D2, Keys.D3, Keys.D4, Keys.D5, Keys.D6, Keys.D7, Keys.D8, 
            Keys.D9
        };
        ...
        /// <summary>
        /// The constructor of EnterPasswordMenuItem.
        /// </summary>
        public EnterPasswordMenuItem() {
            text = "";
            positionHeader = new Vector2((Environment.GameAreaSize.X / 2) - 140 + 8, (Environment.BoxSize.Y + (Environment.GameAreaSize.Y / 2)) - 85);
            position = new Vector2((Environment.GameAreaSize.X / 2) - 151, (Environment.BoxSize.Y + (Environment.GameAreaSize.Y / 2)) - 62);
            positionText = new Vector2((Environment.GameAreaSize.X / 2) - 140 + 18, (Environment.BoxSize.Y + (Environment.GameAreaSize.Y / 2)) -38);
        }
        ...
        public override void DrawItem(SpriteBatch spriteBatch) {
            spriteBatch.DrawString(font, "Password (min. 3 characters)", positionHeader, Color.White);
